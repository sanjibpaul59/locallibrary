...
class Book(models.Model):
    ...
    author = models.ForeignKey(
        'Author', on_delete=models.SET_NULL, null=True, related_name="books_written")
...
class Author(models.Model):
    ...
    def author_age(self):
        if(self.date_of_death):
            ...
            return "Dates were not provided."

    def books_authored(self):
        return self.books_written.all()

    def num_books_authored(self):
        return self.books_written.count()
